    ...
    public partial class DBinit : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FeedbackUser", x => x.FeedbackId);
                    table.ForeignKey(
                        name: "FK_FeedbackUser_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "GroupId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FeedbackUser_Groups_ReviewedUserId",
                        column: x => x.ReviewedUserId,
                        principalTable: "Groups",
                        principalColumn: "GroupId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FeedbackUser_Groups_ReviewerId",
                        column: x => x.ReviewerId,
                        principalTable: "Groups",
                        principalColumn: "GroupId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FeedbackUser_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Requests_User_SenderId",
                        column: x => x.SenderId,
                        principalTable: "User",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_User_Group", x => x.UsergroupId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserconversationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ConversationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_User_Conversation", x => x.UserconversationId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Plan_Details", x => x.PlanDetailsId);
                    table.ForeignKey(
                        name: "FK_Plan_Details_Plans_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReplyComments_User_CommentBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FeedbackUser_GroupId",
                table: "FeedbackUser",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_FeedbackUser_ReviewedUserId",
                table: "FeedbackUser",
                column: "ReviewedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_FeedbackUser_ReviewerId",
                table: "FeedbackUser",
                column: "ReviewerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReplyComments_CommentBy",
                table: "ReplyComments",
                column: "CommentBy");
